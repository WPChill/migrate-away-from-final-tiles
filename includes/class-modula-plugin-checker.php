...
if ( ! class_exists( 'Modula_Plugin_Checker' ) ) {
	...
	class Modula_Plugin_Checker {
		...
		public function display_modula_notice() {
			...
			echo '<h1>' . esc_html__( 'Install & Activate Modula Lite', 'modula-final-tiles-migrator' ) . '</h1>';
			echo '<h4>' . esc_html__( 'In order for the migrator to work properly, you\'ll also need to have Modula installed & activated', 'modula-final-tiles-migrator' ) . '</h4>';
